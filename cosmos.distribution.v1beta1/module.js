...
exports.queryClient = exports.txClient = exports.registry = exports.MsgFundCommunityPool = exports.MsgSetWithdrawAddress = exports.MsgWithdrawDelegatorReward = exports.MsgWithdrawValidatorCommission = void 0;
...
Object.defineProperty(exports, "MsgFundCommunityPool", { enumerable: true, get: function () { return tx_4.MsgFundCommunityPool; } });
    ...
    return {
        ...
        async sendMsgFundCommunityPool({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry, prefix });
                let msg = this.msgFundCommunityPool({ value: tx_4.MsgFundCommunityPool.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgFundCommunityPool({ value }) {
            try {
                return { typeUrl: "/cosmos.distribution.v1beta1.MsgFundCommunityPool", value: tx_4.MsgFundCommunityPool.fromPartial(value) };
            }
            catch (e) {
