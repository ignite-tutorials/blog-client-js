...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSubmitProposal = exports.MsgVoteWeighted = exports.MsgVote = exports.MsgDeposit = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        msgDeposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDeposit", value: tx_1.MsgDeposit.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposal", value: tx_4.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
